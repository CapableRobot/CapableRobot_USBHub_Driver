...
logger.info("     Measured : " + " ".join([("%.2f" % v).rjust(7) for v in hub.currents()]))
logger.info("     Limit    : {}".format(hub.current_limits()))
logger.info("     Alerts   : {}".format(" ".join(hub.current_alerts())))